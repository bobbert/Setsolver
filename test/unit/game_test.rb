...
class GameTest < ActiveSupport::TestCase
  ...
  # Creating a new game should load deck and cards automatically.
  def test_new_game_should_fill_board_and_find_sets
    test_game = Game.new
    test_game.save

    assert_nil test_game.autoshuffle, 
      "Autoshuffle should be turned off for ALL TESTS, so that card ordering is testable."
